...
const BMICalculator = () => {
  ...
  return (
    <div className='flex justify-center bg-gray-800 py-20 h-screen '>
      <div className="w-full max-w-sm h-min p-6  bg-white rounded-lg shadow-lg text-center">
      ...
      <form onSubmit={calculateBMI} className="mb-4">
        ...
        <button
          type="submit"
          className="w-full bg-green-500 font-semibold text-white py-2 px-4 rounded hover:bg-green-700"
        >
          Calculate BMI
        </button>
      </form>
